...
var docReady = setInterval(function(){
    ...
    for(i=0; i<addedCategoriesText.firstElementChild.children.length; i++){
        addedCategoriesText.firstElementChild.children[i].firstChild.addEventListener('click', removeCategoryFromPost);
    }
...
function removeCategoryFromPost(event){
    ...
    var newCategoryIDs = categoryIDArray.join(',');
    addedCategoriesIDs.value = newCategoryIDs;
